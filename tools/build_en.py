...
T = [
 ...
 ('요구 - 3D CAD 경험 (Fusion360 외)', 'REQUIRED - 3D CAD experience (Fusion 360 or similar)'),
 ...
 ('요구 - 3D 프린터, CNC 경험자, 2D / 3D 도면 작성에 관심', 'REQUIRED - 3D printing or CNC experience, interest in 2D / 3D drafting'),
